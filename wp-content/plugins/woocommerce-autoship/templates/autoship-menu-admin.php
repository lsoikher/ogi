		...
		<section class="card col-xs-12">
			...
			<div class="wc-autoship-menu">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-sm-offset-1">
						<a class="wc-autoship-menu-link btn btn-block btn-xl btn-card"
							href="<?php echo add_query_arg( array( 'customer_id' => $customer->get_id() ), get_permalink( get_option( 'wc_autoship_schedules_page_id' ) ) ); ?>"> 
				...
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-sm-offset-1">
						<a class="wc-autoship-menu-link btn btn-block btn-xl btn-card"
							href="<?php echo add_query_arg( array( 'customer_id' => $customer->get_id() ), get_permalink( get_option( 'wc_autoship_billing_page_id' ) ) ); ?>"> 
				...
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-sm-offset-1">
						<a class="wc-autoship-menu-link btn btn-block btn-xl btn-card"
							href="<?php echo add_query_arg( array( 'customer_id' => $customer->get_id() ), get_permalink( get_option( 'wc_autoship_shipping_page_id' ) ) ); ?>"> 
