...
<form method="get" class="wc-autoship-search-form">
	...
	<?php echo $list_table->search_box( 'Search items', 'wc-autoship-admin-search' ); ?>
</form>

<p>Manage autoship items.</p>

<?php 
$export_url = add_query_arg( array(
	'action' => 'export_autoship_items',
	'per_page' => '999999',
...
<p><a href="<?php echo esc_attr( $export_url ); ?>" 
	target="_blank" class="button">Export Item Results</a></p>

<form id="items-filter" method="post" class="wc-autoship-admin-form">
	<input type="hidden" name="page" class="wc-autoship-admin-page" value="<?php echo esc_attr( $_REQUEST['page'] ); ?>" />
