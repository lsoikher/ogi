			...
			<div class="uap-dashboard-top-affiliate">
				...
				<?php foreach ($data['top_affiliates'] as $key=>$value): ?>
					<div class="uap-dashboard-top-affiliate-single">
					 ...
					 <div class="uap-top-count"><?php _e('Refferals', 'uap');?> <?php echo $value['referrals'];?> | <?php _e('Total Amount', 'uap');?> <?php echo uap_format_price_and_currency($data['currency'], $value['sum']);?> </div>
					</div>
					<?php $i++;?>
				<?php endforeach;?>	
			</div>
