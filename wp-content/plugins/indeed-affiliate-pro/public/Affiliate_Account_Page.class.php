...
if (!class_exists('Affiliate_Account_Page')){ 
	class Affiliate_Account_Page{
		...
		private function run_custom_tab($tab=''){
			$key = $tab;
			$data['content'] = (isset($this->account_page_settings['uap_tab_' . $key . '_content'])) ? ihc_replace_constants($this->account_page_settings['uap_tab_' . $key . '_content'], $this->uid) : '';
			$data['title'] = (isset($this->account_page_settings['uap_tab_' . $key . '_title'])) ? ihc_replace_constants($this->account_page_settings['uap_tab_' . $key . '_title'], $this->uid) : '';			 
