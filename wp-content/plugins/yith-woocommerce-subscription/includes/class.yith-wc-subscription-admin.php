...
if ( !class_exists( 'YITH_WC_Subscription_Admin' ) ) {
    ...
    class YITH_WC_Subscription_Admin {
        ...
        public function add_custom_fields_for_single_products() {
            ...
            $_ywsbs_price_is_per           = get_post_meta( $thepostid, '_ywsbs_price_is_per', true );
            $_ywsbs_price_time_option      = get_post_meta( $thepostid, '_ywsbs_price_time_option', true );
            $_ywsbs_max_length             = get_post_meta( $thepostid, '_ywsbs_max_length', true );
...
<?php
        ...
        public function save_custom_fields_for_single_products( $post_id, $post ){
            ...
            if ( isset( $_POST['_ywsbs_subscription'] ) ){
                update_post_meta( $post_id, '_ywsbs_subscription',  'yes' );
            }else{
                update_post_meta( $post_id, '_ywsbs_subscription',  'no' );
            }

            if ( isset( $_POST['_ywsbs_price_is_per'] ) ){
                update_post_meta( $post_id, '_ywsbs_price_is_per',  $_POST['_ywsbs_price_is_per'] );
            }


            if ( isset( $_POST['_ywsbs_price_time_option'] ) ){
                update_post_meta( $post_id, '_ywsbs_price_time_option',  $_POST['_ywsbs_price_time_option'] );
            }
            ...
            if ( isset( $_POST['_ywsbs_price_time_option'] ) && isset( $_POST['_ywsbs_max_length'] ) ) {
                ...
                update_post_meta( $post_id, '_ywsbs_max_length', $max_length );
            }
