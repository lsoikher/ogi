...
if ( ! function_exists( 'wccpl_get_pro_message' ) ) {
	...
	function wccpl_get_pro_message() {
		return sprintf( __( 'Get <a href="%s">Custom Price Labels for WooCommerce Pro</a> plugin to change value.', 'woocommerce-custom-price-label' ), 'https://wpcodefactory.com/item/custom-price-labels-for-woocommerce-plugin/' );
	}
}