...
class WC_Custom_Price_Label_Settings_Global extends Alg_WC_Custom_Price_Labels_Settings_Section {
	 ...
	 * @version 2.4.0
	 * @since   2.3.0
	 * @todo    (maybe) all products - instead of the price (check Booster)
	 * @todo    (maybe) "show/hide options" and "user roles options" for each label separately (as in per product)
	 */
