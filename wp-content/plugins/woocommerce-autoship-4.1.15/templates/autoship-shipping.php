...
<div class="wc-autoship-container">
	...
	<form method="post" action="<?php echo admin_url( 'admin-ajax.php?action=customer_action_submit_shipping_method' ); ?>" class="wc-autoship-shipping">
		...
		<div class="row">
			...
			<section class="card col-xs-12">
				...
				<ol class="breadcrumb text-center">
					...
					<li class="active"><a href="<?php echo get_permalink( get_option( 'wc_autoship_shipping_page_id' ) ); ?>"><?php echo __( 'Shipping &amp; Delivery', 'wc-autoship' ); ?></a></li>
				</ol>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<a
						...
						href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ), $edit_shipping_path; ?>">
						<?php echo __( 'Edit Shipping Address', 'wc-autoship' ); ?>
					</a>
				</div>
