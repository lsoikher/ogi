...
<div class="wc-autoship-container">
	<div class="wc-autoship-billing wc-autoship-billing-admin">
		<div class="row">
			<!-- card section -->
			<section class="card col-xs-12">
				...
				<ol class="breadcrumb text-center">
					...
					<li class="active"><a href="<?php echo add_query_arg( array( 'customer_id' => $customer->get_id() ), get_permalink( get_option( 'wc_autoship_billing_page_id' ) ) ); ?>"><?php echo __( 'Billing', 'wc-autoship' ); ?></a></li>
				</ol>
				<hr />
				...
				<div class="col-xs-12 col-sm-6">
					...
					<a class="wc-autoship-edit-billing-address-link btn btn-primary btn-sm center-block"
