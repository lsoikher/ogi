					...
					<div class="advanced-options-content">
						...
						<div class="js-all-pages-content acordion-main-div-content">
							...
							<div class="js-pages-selectbox-content acordion-main-div-content">
								...
								<select class="js-all-pages js-multiselect" multiple data-slectbox="all-selected-page" data-sorce="<?php echo SG_POST_TYPE_PAGE; ?>" size="10" >
								...
								<input type="hidden" class="js-sg-selected-pages" name="all-selected-page" value="">
							</div>
						</div>
						...
						<div class="js-all-posts-content acordion-main-div-content">
							...
							<div class="js-posts-selectbox-content acordion-main-div-content">
								...
								<select class="js-all-posts js-multiselect" multiple data-slectbox="all-selected-posts" data-sorce="<?php echo SG_POST_TYPE_POST; ?>" size="10" >
								...
								<input type="hidden" class="js-sg-selected-posts" name="all-selected-posts" value="">
							</div>
							<div class="js-all-categories-content acordion-main-div-content">
								...
								echo SGFunctions::createSelectBox($categories, @$sgPostsAllCategories, array("name"=>"posts-all-categories[]","multiple"=>"multiple","size"=>10 )); ?>
							</div>
						</div>
