...
class InstapageHelper
{
  ...
  public static function updateOptions( $data )
  {
    ...
    $db = DBModel::getInstance();
    $sql = 'INSERT INTO ' . $db->optionsTable . '(id, plugin_hash, api_keys, user_name, config) VALUES(1, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE plugin_hash = %s, api_keys = %s, user_name = %s, config = %s';
    
    return $db->query( $sql, $userToken, '', $userName, $configJson, $userToken, '', $userName, $configJson );
  }
