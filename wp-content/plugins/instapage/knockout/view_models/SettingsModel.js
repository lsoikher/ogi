...
var SettingsModel = function SettingsModel(data) {
  ...
  self.email = data.user_name ? instapageKO.observable(data.user_name) : instapageKO.observable();
  self.userToken = data.plugin_hash ? instapageKO.observable(data.plugin_hash) : instapageKO.observable();
