  ...
  <div class="instapage-content ui-sub-section">
    ...
    <form class="c-section l-space-tertiary">
      ...
      <div class="diagnostic-form ui-section">
        ...
        <p class="l-space-bottom-tertiary"><?php echo InstapageCmsPluginConnector::lang( 'Diagnostic tool helps our customer support and developers to track and eliminate some most problematic issues. Do not turn this option on if unnecessary, it can increase your page loading time.' ); ?></p>
        <label class="c-mark">
