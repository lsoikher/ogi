...
class InstapageCmsPluginDebugLogModel
{
  ...
  public function getLogHTML()
  {
    if( InstapageCmsPluginConnector::currentUserCanManage() && $this->isDiagnosticMode() )
    {
      try
      {
        $plugins_html = InstapageCmsPluginConnector::getSelectedConnector()->getPluginsDebugHTML();
        $options_html = InstapageCmsPluginConnector::getSelectedConnector()->getOptionsDebugHTML();
