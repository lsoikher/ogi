<?php
// log.php is a template file. It's ment to be included in other php files. To work properly variables need to be set before file inclusion:
// string $current_date - current date in readable format
// array $rows - log entries as objects with properties:
...
// string $plugins_html - html containing a list of other installed plugins or modules
// string $options_html - html containing options of the CMS
// string $phpinfo_html - html containing phpinfo() output
?>
<!DOCTYPE html>
<html>
	<head>
		<title><?php echo InstapageCmsPluginConnector::lang('Instapage Log' ) . ' ' . $current_date; ?></title>
		<style>
			body
			{
				background: #EFEFEF;
