<?php
    ...
    function trusona_custom_login($url) {
        $data = '<div>';
        ...
        $data .= '<a href="#" style="font-size:smaller;color:#c0c0c0;" onclick="$(\'form > p\').toggle();this.blur();return false;">Toggle Classic Login</a></div><br/></div> ';
