 ...
 */
                       ...
                       jQuery.noConflict();
                        ...
                        jQuery(document).ready(function($) {                                                        
                          ...
                          newHtml +=  '<a href="/wp-admin/edit.php?post_type=vtprd-rule&page=vtprd_show_help_page&doThis=showRuleInfo&ruleID=';
      ...
      */                                 
                          ...
                          function add_Bulk_line_cntl() {
                            ...
                            $(AddButton).click(function (e)  //on add input button click
                            {
                                ...
                                bulkHtml +=  '<span class="pricing_table_column4"><input type="number" step="0.01" placeholder="0.00" name="discountVal[]" id="discountVal_row_'+ RowCount +'" value=""/></span>';
