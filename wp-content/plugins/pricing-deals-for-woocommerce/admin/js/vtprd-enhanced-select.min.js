...
*/
        ...
        // NO Ajax role search box - all roles are pre-loaded
				//.vtprd-role-search = select box class
        $( ':input.vtprd-role-search' ).each( function() {
					var select2_args = {
						allowClear:  $( this ).data( 'allow_clear' ) ? true : false,
						placeholder: $( this ).data( 'placeholder' ),
            multiple: true,
        ...
        // NO Ajax brand search box - all brands are pre-loaded
				//.vtprd-brand-search = select box class
        $( ':input.vtprd-brand-search' ).each( function() {
					var select2_args = {
						allowClear:  $( this ).data( 'allow_clear' ) ? true : false,
						placeholder: $( this ).data( 'placeholder' ),
            multiple: true,
