  ...
  public function vtprd_enqueue_admin_scripts() {
    ...
    if( get_post_type() == 'vtprd-rule' ){         //v1.0.8.2   can't just test $post_type here, not always accurate!
       ...
       //qtip resources named jquery-qtip, to agree with same name used in wordpress-seo from yoast!
        ...
        wp_register_script('vtprd-enhanced-select', VTPRD_URL.'/admin/js/vtprd-enhanced-select.js' );  
          ...
          <div class="blue-line  blue-line-less-top  clear-left">
              ...
              <span class="blue-dropdown  scheduling-group  right-column" id="scheduling-area">   
                ...
                <?php //   <label class="scheduling-label">Scheduling</label> ?>                                              
                    ...
                    <img  class="hasHoverHelp2" width="18px" alt="" style="margin-top:32px;margin-left:9px;"  src="<?php echo VTPRD_URL;?>/admin/images/help.png" /> 
      ...
      <div class="display-virtual_box rule_deal_info" id="rule_deal_info_line<?php echo '_' .$k; ?>">   
        <div class="display-virtual_box" id="buy_info<?php echo '_' .$k; ?>">  
         ...
         <div class="screen-box buy_group_title_box">
            ...
            <span class="bogo-titles label-no-cap hideMe" style="margin-left:2%;color:#555;font-style:italic;float: left;">( Buy Group )</span>
                        ...
                        */
                        ...
                        if ($bulk_deal_array_count > 0) {  //send existing rows
                            ...
                            for($b=0; $b < $bulk_deal_array_count; $b++) {
                              ...
                              $newHtml .=  '<span class="pricing_table_column4" id="discountVal_'.$RowCount.'" ><input  type="number" step="0.01" placeholder="0.00" name="discountVal[]" id="discountVal_row_'. $RowCount.'" value="'.$discount_value.'"/></span>';
                              ...
                              $newHtml .=  '<span class="pricing_table_column4" id="discountVal_'.$RowCount.'" ><input  type="number" step="0.01" placeholder="0.00" name="discountVal[]" id="discountVal_row_'. $RowCount.'" value=""/></span>';
                              $newHtml .=  '<a href="#" class="removeclass">X</a>';
                              $newHtml .=  '</div>'; 
                              echo $newHtml;                    
                        }                
...
//echo '$vtprd_rule= <pre>'.print_r($vtprd_rule, true).'</pre>' ; 
  ...
  //*******************
  public function vtprd_build_cat_selects ($taxonomy, $checked_list = NULL ) {
        //error_logog( print_r(  'function vtprd_build_cat_selects begin in rules-ui, $taxonomy= ' .$taxonomy, true ) );
        //error_logog( print_r(  '$checked_list = ', true ) );
        //error_logog( var_export($checked_list, true ) );
  ...
  //v2.0.0 new function
  //*******************
  public function vtprd_build_role_selects ($checked_list = NULL ) {
