...
<html>
	<head>			
		...
		<script>
			...
			function gen_shortcode() {
				...
				} else if(jQuery('#cat_slugs').val()!='') {
					shortcode +=' cat_slugs="'+jQuery('#cat_slugs').val()+'"';
				}			
	...
	<body>
		<table cellspacing="5" cellpadding="5">
				...
				<tr>
					<td align="left">Category Slugs</td>
					<td>
						<input type="text" name="cat_slugs" id="cat_slugs" value="" size="30"> <span class="smalltext">Please enter Category Slugs with comma seperated</span>
					</td>
				</tr>
				<tr>
