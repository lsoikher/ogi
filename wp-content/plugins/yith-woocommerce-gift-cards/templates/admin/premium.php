...
.section.two{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/02-bg.png) no-repeat #fff; background-position: 15% 75%
}
.section.three{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/03-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.four{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/04-bg.png) no-repeat #fff; background-position: 15% 75%
}
.section.five{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/05-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.six{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/06-bg.png) no-repeat #fff; background-position: 15% 75%
}
.section.seven{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/07-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.nine{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/09-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.ten{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/10-bg.png) no-repeat #fff; background-position: 15% 75%
}
.section.eleven{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/11-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.twelve{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/12-bg.png) no-repeat #fff; background-position: 15% 75%
}
.section.thirteen{
    background: url(<?php echo YITH_YWGC_ASSETS_URL ?>/images/13-bg.png) no-repeat #fff; background-position: 85% 75%
}
.section.fourteen{
